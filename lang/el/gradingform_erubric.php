...
$string['criterion'] = 'Κριτήριο {$a}'; //New
$string['level'] = 'Επίπεδο {$a->definition}, {$a->score} points.'; //New
$string['leveldefinition'] = 'Περιγραφή επιπέδου {$a}'; //New
$string['levelsgroup'] = 'Ομάδα επιπέδων'; //New
$string['scoreinputforlevel'] = 'Απόδοση βαθμού για το επίπεδο {$a}'; //New
...
$string['criterionduplicate'] = 'Αντιγραφή κριτηρίου'; //New
...
$string['rubricmappingexplained'] = 'Το ελάχιστο δυνατό αποτέλεσμα της εμπλουτισμένης ρουμπρίκας είναι <b>{$a->minscore} βαθμοί</b> 
    ...
    Μπορείτε να αλλάξετε αυτόν τον τρόπο υπολογισμού, επιλέγοντας \'Υπολογισμός βαθμολογίας θεωρώντας πως η βαθμολογία της ρουμπρίκας ξεκινά από το μηδέν (0)\' στις επιλογές της ρουμπρίκας.'; //New
...
$string['criterionremark'] = 'Σχόλιο κριτηρίου {$a->description}: {$a->remark}'; //New
$string['privacy:metadata:fillings'] = 'Ό πίνακας στη Βάση Δεδομένων που αποθηκεύει βαθμολογικές πληροφορίες και παραγόμενα από Learning Analytics και Data Mining.'; //New
$string['privacy:metadata:fillings:instanceid'] = 'Ο κωδικός του στιγμιότυπου βαθμολόγησης ενός βαθμολογητή που χρησιμοποιεί μια ε-ρουμπρίκα.'; //New
$string['privacy:metadata:fillings:criterionid'] = 'Ο κωδικός κριτηρίου μιας ε-ρουμπρίκας που χρησιμοποπιήθηκε για βαθμολόγηση.'; //New
$string['privacy:metadata:fillings:levelid'] = 'Ο κωδικός του επιλεγμένου επιπέδου ενός κριτηρίου ε-ρουμπρίκας.'; //New
$string['privacy:metadata:fillings:remark'] = 'Οι παρατηρήσεις αξιολόγησης του βαθμολογητή, βάση του κριτηρίου της ε-ρουμπρίκας.'; //New
$string['privacy:metadata:fillings:enrichedbenchmark'] = 'Η τελική τιμή αναφοράς που προέκυψε από την επεξεργασία των Μαθησιακών Αλληλεπιδράσεων και την Εξόρυξη Δεδομένων.'; //New
$string['privacy:metadata:fillings:enrichedbenchmarkstudent'] = 'Η τιμή αναφοράς του μαθητή που προέκυψε από την επεξεργασία των Μαθησιακών Αλληλεπιδράσεων και την Εξόρυξη Δεδομένων.'; //New
$string['privacy:metadata:fillings:enrichedbenchmarkstudents'] = 'Η συγκεντρωτική τιμή αναφοράς των εν ενεργεία μαθητών που προέκυψε από την επεξεργασία των Μαθησιακών Αλληλεπιδράσεων και την Εξόρυξη Δεδομένων.'; //New
...
$string['zerolevelsabsent'] = 'Προσοχή: Η ελάχιστη δυνατή βαθμολογία για τη συγκεκριμένη ρουμπρίκα δεν είναι μηδέν (0). Αυτό μπορεί να παράγει απροσδόκητα αποτελέσματα για τη συγκεκριμένη βαθμολογική δραστηριότητα.
    ...
    Αυτή η προειδοποίηση μπορεί να αγνοηθεί, αν για τη συγκεκριμένη βαθμολογική δραστηριότητα χρησιμοποιείτε διαβαθμισμένη κλίμακα αντί αριθμητικής βαθμολογίας και η ελάχιστη βαθμολογία της ρουμπρίκας αναλογεί στην ελάχιστη τιμή της κλίμακας.'; //New
$string['err_novariations'] = 'Η ελάχιστη βαθμολογία της ρουμπρίκας δεν μπορεί να είναι ίδια με τη μέγιστη.'; //New
$string['err_novariationspoints'] = 'Τα επίπεδα ενός κριτηρίου δεν μπορούν να έχουν τις ίδιες τιμές.'; //New
$string['err_novariationsvalues'] = 'Τα εμπλουτισμένα κριτήρια πρέπει να έχουν διαφορετικές τιμές ελέγχου σε κάθε επίπεδο.'; //New for enrichment
...
$string['lockzeropoints'] = 'Υπολογισμός βαθμολογίας θεωρώντας πως η βαθμολογία της ρουμπρίκας ξεκινά από το μηδέν (0).'; //New
$string['lockzeropoints_help'] = 'Αυτή η παράμετρος εφαρμόζεται αν το άθροισμα των ελάχιστων βαθμών όλων των κριτηρίων
    ...
    Για περισσότερες πληροφορίες δείτε τις οδηγίες χρήσης του εργαλείου σχετικά με τον <a target="_blank" href="https://docs.moodle.org/35/el/Learning_Analytics_Enriched_Rubric#Grade_calculation">υπολογισμό βαθμολογίας</a>'; //New
