...
$string['erubric'] = 'Εμπλουτισμένη Ρουμπρίκα Μαθησιακής Αναλυτικής';
...
$string['enrichshareconfirm'] = '<p style="text-align:center;color:red;font-weight:bold">ΠΡΟΣΟΧΗ!</p>
    Το πρόσθετο <b>Εμπλουτισμένη Ρουμπρίκα Μαθησιακής Αναλυτικής</b> μπορεί να χρησιμοποιηθεί ως πρότυπο διαμοιρασμού, ΜΟΝΟ ΓΙΑ ΤΟ ΠΑΡΟΝ ΜΑΘΗΜΑ!
